...
List<RentalHousesMd> rentalHousesListMdFromJson(String str) =>
    List<RentalHousesMd>.from(
      (json.decode(str) as List)
          .map((e) => RentalHousesMd.fromJson(e as Map<String, dynamic>)),
    );

String rentalHousesListMdToJson(List<RentalHousesMd> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class RentalHousesMd {
  RentalHousesMd({
    this.name,
    this.price,
    this.currency,
  ...
  factory RentalHousesMd.fromJson(Map<String, dynamic> json) => RentalHousesMd(
