...
List<RentalHomeAndServiceMd> rentalHousesListMdFromJson(String str) =>
    List<RentalHomeAndServiceMd>.from(
      (json.decode(str) as List).map(
        (e) => RentalHomeAndServiceMd.fromJson(e as Map<String, dynamic>),
      ),
    );

String rentalHousesListMdToJson(List<RentalHomeAndServiceMd> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class RentalHomeAndServiceMd {
  ...
  factory RentalHomeAndServiceMd.fromJson(Map<String, dynamic> json) =>
      RentalHomeAndServiceMd(
