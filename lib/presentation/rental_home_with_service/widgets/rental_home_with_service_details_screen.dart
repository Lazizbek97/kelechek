...
class RentalHomeWithServiceDetailsScreen extends StatefulWidget {
  const RentalHomeWithServiceDetailsScreen({
  ...
  static Route<void> route({
    required RentalHomeAndServiceMd rentalHomeAndServiceMd,
  }) {
    return MaterialPageRoute<void>(
      builder: (_) => RentalHomeWithServiceDetailsScreen(
        rentalHomeAndServiceMd: rentalHomeAndServiceMd,
      ),
    );
  }

  @override
  State<RentalHomeWithServiceDetailsScreen> createState() =>
      _RentalHomeWithServiceDetailsScreenState();
}

class _RentalHomeWithServiceDetailsScreenState
    extends State<RentalHomeWithServiceDetailsScreen> {
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Stack(
                children: [
                  PageView(
                    children: [
                      ...widget.rentalHomeAndServiceMd.images?.map(
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        '1/${widget.rentalHomeAndServiceMd.images?.length}',
          ...
          SliverList(
            delegate: SliverChildListDelegate(
              [
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Spacer(),
                      ...List.generate(
                        widget.rentalHomeAndServiceMd.contact?.length ?? 0,
                        (index) => Padding(
                          padding: const EdgeInsets.only(left: 8),
                          child: CstIconButton(
                            onPressed: () {
                              if (widget.rentalHomeAndServiceMd.contact?[index]
                                      .type ==
                                  'chat') {
                ...
                const SizedBox(height: 20),
                _ListContent(
                  text: widget.rentalHomeAndServiceMd.roomSizeName ?? '',
                  iconPath: AppIcon.homeHashtag,
                ),
                const SizedBox(height: 10),
                _ListContent(
                  text: widget.rentalHomeAndServiceMd.address?.name ?? '',
                          ...
                          children: [
                            ...
                            GestureDetector(
                              ...
                              onTap: () async {
                                ...
                                //    showModalBottomSheet<void>(
                                //   context: context,1  ${l10n.number} / ${num2} ${l10n.adults} / ${num3} ${l10n.kids}
                                //   backgroundColor: Colors.white,
                                //   isScrollControlled: true,
                                //   builder: (BuildContext context) {
                                //     return RangeCalendarWidget();
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    ...
                    child: Text(
                      '${num1}  ${l10n.number.toLowerCase()} / ${num2}${num2} ${l10n.adults} / ${num3} ${l10n.kids}',
                      style: AppTextStyle.s16.copyWith(
                        color: AppColors.lightBlue,
                ...
                Wrap(
                  ...
                  runSpacing: 10,
                  children: [
                    ...widget.rentalHomeAndServiceMd.amenities?.map(
  ...
  Future<void> onRent(BuildContext context) async {
    ...
    final order = OrdersModel(
      productName: widget.rentalHomeAndServiceMd.name ?? '',
      productInfo: widget.rentalHomeAndServiceMd.description ?? '',
      size: widget.rentalHomeAndServiceMd.roomSizeName ?? '',
      price: widget.rentalHomeAndServiceMd.price ?? 0,
      rentalPeriodFromDate: DateTime.now().formatInStyle('dd/MM/yyyy'),
      rentalPeriodToDate: DateTime.now()
          .add(const Duration(days: 30))
          .formatInStyle('dd/MM/yyyy'),
      address: widget.rentalHomeAndServiceMd.address?.name ?? '',
